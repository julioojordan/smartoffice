...
<pre><code>$('.show-menu a').on('click', function(e){
    ...
    // When nav is not visible make nav show
        ...
        return false;
                ...
                <div class="col-md-6">
                    ...
                    <div id="img-grid-wapper">
                        <div class="col-xs-6"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-6"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-4"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-4"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-4"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-3"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-3"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-3"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                        <div class="col-xs-3"><img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded"></div>
                    </div>
                ...
                <div class="col-xs-12">
                    ...
                    <p class="img-n-pargaraph">
                        <img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded col-sm-4 pull-right">
                    ...
                    <p class="img-n-pargaraph">
                        <img src="<?php echo base_url() . 'assets/images/blur_img.jpg' ?>" alt="" class="img-responsive img-rounded col-sm-4 pull-left">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <p>
        ...
        <script src="<?php echo base_url() . 'assets/js/templatemo_scripts.js' ?>"></script>
    </body>
</html>